  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-64 bg-slate-900 flex flex-col z-10">
      ...
      <nav className="flex-1 px-3 py-4 space-y-4 overflow-y-auto">
        <NavGroup title="Каталог" items={catalogItems} pathname={pathname} />
        <NavGroup title="Контент" items={contentItems} pathname={pathname} />
        <NavGroup title="Настройки" items={settingsItems} pathname={pathname} />
      </nav>
